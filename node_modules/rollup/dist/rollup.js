...
function umd(magicString, _a, options) {
    ...
    if (options.noConflict === true) {
        ...
        if (!namedExportsMode && hasExports) {
            ...
            factory = "var exports" + _ + "=" + _ + module_1 + ";" + n;
    ...
    Scope.prototype.deshadow = function (names, children) {
        ...
        for (var _i = 0, _a = Object.keys(this.variables); _i < _a.length; _i++) {
            ...
            if (declaration.isDefault)
                continue;
            var name_1 = declaration.getName(true);
            if (!names.has(name_1))
                continue;
            name_1 = declaration.name;
            var deshadowed = void 0, i = 1;
            do {
                deshadowed = name_1 + "$$" + toBase64(i++);
...
var AwaitExpression$1 = /** @class */ (function (_super) {
    ...
    AwaitExpression.prototype.include = function () {
        ...
        if (!this.context.usesTopLevelAwait) {
            ...
            do {
                if (parent_1 instanceof FunctionNode || parent_1 instanceof ArrowFunctionExpression$1)
                    return;
            } while ((parent_1 = parent_1.parent));
...
var UpdateExpression$1 = /** @class */ (function (_super) {
    ...
    UpdateExpression.prototype.render = function (code, options) {
        ...
        if (options.format === 'system' && variable && variable.exportName) {
            var name_1 = variable.getName();
            if (this.prefix) {
                code.overwrite(this.start, this.end, "exports('" + variable.exportName + "', " + this.operator + name_1 + ")");
            }
            else {
                var op = void 0;
                ...
                code.overwrite(this.start, this.end, "(exports('" + variable.exportName + "', " + op + "), " + name_1 + this.operator + ")");
            }
        }
    };
...
var addDeclaredNames = function (variable, names) {
    if (variable.isNamespace && !variable.isExternal) {
        for (var _i = 0, _a = variable.context.getExports(); _i < _a.length; _i++) {
            var name_1 = _a[_i];
            addDeclaredNames(variable.context.traceExport(name_1), names);
        }
    }
    ...
    ModuleScope.prototype.deshadow = function (names, children) {
        ...
        for (var _i = 0, _a = Object.keys(this.context.imports); _i < _a.length; _i++) {
            ...
            for (var _b = 0, _c = importDescription.module.getAllExports(); _b < _c.length; _b++) {
                var name_2 = _c[_b];
                addDeclaredNames(importDescription.module.traceExport(name_2), localNames);
            }
            if (importDescription.name !== '*') {
                ...
                var name_3 = declaration.getName();
                if (name_3 !== importDescription.name)
                    localNames.add(name_3);
...
var NamespaceVariable = /** @class */ (function (_super) {
    ...
    function NamespaceVariable(context, module) {
        ...
        for (var _i = 0, _a = _this.context.getExports().concat(_this.context.getReexports()); _i < _a.length; _i++) {
            var name_1 = _a[_i];
            _this.originals[name_1] = _this.context.traceExport(name_1);
        }
        return _this;
    }
...
var Module = /** @class */ (function () {
        ...
        if (source) {
            ...
            if (node.type === ExportAllDeclaration) {
                ...
                for (var _i = 0, _a = node.specifiers; _i < _a.length; _i++) {
                    var specifier = _a[_i];
                    var name_1 = specifier.exported.name;
                    if (this.exports[name_1] || this.reexports[name_1]) {
                        this.error({
                            code: 'DUPLICATE_EXPORT',
                            message: "A module cannot have multiple exports with the same name ('" + name_1 + "')"
                        }, specifier.start);
                    }
                    this.reexports[name_1] = {
    ...
    Module.prototype.addImport = function (node) {
        ...
        for (var _i = 0, _a = node.specifiers; _i < _a.length; _i++) {
            ...
            var name_2 = isDefault
                ? 'default'
                : isNamespace
                    ? '*'
                    : specifier.imported.name;
            this.imports[localName] = { source: source, start: specifier.start, name: name_2, module: null };
        }
    };
    ...
    Module.prototype.markPublicExports = function () {
        ...
        for (var _b = 0, _c = this.getReexports(); _b < _c.length; _b++) {
            var name_3 = _c[_b];
            var variable = this.traceExport(name_3);
            variable.exportName = name_3;
    ...
    Module.prototype.linkDependencies = function () {
        ...
        for (var _i = 0, _a = this.sources; _i < _a.length; _i++) {
            ...
            if (id) {
                var module_1 = this.graph.moduleById.get(id);
                this.dependencies.push(module_1);
            }
        }
        var resolveSpecifiers = function (specifiers) {
            for (var _i = 0, _a = Object.keys(specifiers); _i < _a.length; _i++) {
                var name_4 = _a[_i];
                var specifier = specifiers[name_4];
    ...
    Module.prototype.error = function (props, pos) {
        if (pos !== undefined) {
            props.pos = pos;
            var location_1 = locate(this.code, pos, { offsetLine: 1 });
            try {
                location_1 = getOriginalLocation(this.sourcemapChain, location_1);
            }
            catch (e) {
                this.warn({
                    loc: {
            ...
            props.frame = getCodeFrame(this.originalCode, location_1.line, location_1.column);
        }
        error(props);
    };
    ...
    Module.prototype.getReexports = function () {
        ...
        for (var name_6 in this.reexports) {
            reexports[name_6] = true;
        }
        this.exportAllModules.forEach(function (module) {
            if (module.isExternal) {
    ...
    Module.prototype.traceExport = function (name, isExportAllSearch) {
        ...
        if (exportDeclaration) {
            var name_8 = exportDeclaration.localName;
            var declaration = this.traceVariable(name_8) || this.graph.scope.findVariable(name_8);
            return declaration;
        }
        if (name !== 'default') {
            for (var i = 0; i < this.exportAllModules.length; i += 1) {
                var module_3 = this.exportAllModules[i];
                var declaration = module_3.traceExport(name, true);
                if (declaration)
                    return declaration;
            }
        }
...
var Chunk$1 = /** @class */ (function () {
    function Chunk(graph, orderedModules) {
        ...
        for (var _i = 0, orderedModules_1 = orderedModules; _i < orderedModules_1.length; _i++) {
            var module_1 = orderedModules_1[_i];
            if (this.isEmpty && module_1.isIncluded()) {
                this.isEmpty = false;
            }
            if (module_1.chunkAlias) {
                this.isManualChunk = true;
            }
            module_1.chunk = this;
            if (module_1.isEntryPoint && !this.entryModule) {
                this.entryModule = module_1;
    ...
    Chunk.prototype.prepareDynamicImports = function () {
        for (var _i = 0, _a = this.orderedModules; _i < _a.length; _i++) {
            var module_3 = _a[_i];
            for (var i = 0; i < module_3.dynamicImportResolutions.length; i++) {
                var node = module_3.dynamicImports[i];
                var resolution = module_3.dynamicImportResolutions[i].resolution;
                if (!resolution)
                    continue;
    ...
    Chunk.prototype.finaliseDynamicImports = function () {
        for (var i = 0; i < this.orderedModules.length; i++) {
            var module_4 = this.orderedModules[i];
            var code = this.renderedModuleSources[i];
            for (var j = 0; j < module_4.dynamicImportResolutions.length; j++) {
                var node = module_4.dynamicImports[j];
                var resolution = module_4.dynamicImportResolutions[j].resolution;
                if (!resolution)
                    continue;
                if (resolution instanceof Module) {
                    if (resolution.chunk !== this) {
    ...
    Chunk.prototype.finaliseImportMetas = function (options) {
        ...
        for (var i = 0; i < this.orderedModules.length; i++) {
            var module_5 = this.orderedModules[i];
            var code = this.renderedModuleSources[i];
            for (var _i = 0, _a = module_5.importMetas; _i < _a.length; _i++) {
    ...
    Chunk.prototype.getChunkDependencyDeclarations = function (options, inputBase) {
        ...
        for (var _i = 0, _a = Object.keys(this.exportNames); _i < _a.length; _i++) {
            ...
            if (exportName[0] === '*') {
                ...
                var module_6 = this.exports.get(variable);
                // skip local exports
                if (module_6.chunk === this)
                    continue;
                if (module_6 instanceof Module) {
                    exportModule = module_6.chunk;
                    importName = module_6.chunk.getVariableExportName(variable);
                }
                else {
                    exportModule = module_6;
        ...
        this.dependencies.forEach(function (dep) {
            ...
            if (importSpecifiers.length) {
                ...
                for (var _i = 0, importSpecifiers_1 = importSpecifiers; _i < importSpecifiers_1.length; _i++) {
                    var _a = importSpecifiers_1[_i], variable = _a[0], module_7 = _a[1];
                    var local = variable.safeName || variable.name;
                    var imported = void 0;
                    if (module_7 instanceof ExternalModule) {
                        imported = variable.name;
                    }
                    else {
                        imported = module_7.chunk.getVariableExportName(variable);
                    }
    ...
    Chunk.prototype.getChunkExportDeclarations = function () {
        ...
        var _loop_2 = function (exportName) {
            ...
            var module_8 = this_2.exports.get(variable);
            // skip external exports
            if (module_8.chunk !== this_2)
                return "continue";
    ...
    Chunk.prototype.preRender = function (options, inputBase) {
        ...
        if (this.isEntryModuleFacade) {
            ...
            for (var _b = 0, _c = Array.from(this.imports.values()); _b < _c.length; _b++) {
                var module_9 = _c[_b];
                var chunkOrExternal = module_9 instanceof Module ? module_9.chunk : module_9;
        ...
        for (var i = 0; i < this.orderedModules.length; i++) {
            var module_10 = this.orderedModules[i];
            var source = module_10.render(renderOptions);
            source.trim();
            if (options.compact && source.lastLine().indexOf('//') !== -1)
                source.append('\n');
            this.renderedModuleSources.push(source);
            var _d = module_10.getRenderedExports(), renderedExports = _d.renderedExports, removedExports = _d.removedExports;
            this.renderedModules[module_10.id] = {
                renderedExports: renderedExports,
                removedExports: removedExports,
                renderedLength: source.length(),
                originalLength: module_10.originalCode.length
            };
            var namespace = module_10.getOrCreateNamespace();
            if (namespace.needsNamespaceBlock || !source.isEmpty()) {
                magicString.addSource(source);
                this.usedModules.push(module_10);
                if (namespace.needsNamespaceBlock) {
    ...
    Chunk.prototype.merge = function (chunk, chunkList, options, inputBase) {
        ...
        for (var _i = 0, _a = chunk.orderedModules; _i < _a.length; _i++) {
            var module_11 = _a[_i];
            module_11.chunk = this;
            this.orderedModules.push(module_11);
        }
        for (var _b = 0, _c = Array.from(chunk.imports.entries()); _b < _c.length; _b++) {
            var _d = _c[_b], variable = _d[0], module_12 = _d[1];
            if (!this.imports.has(variable) && module_12.chunk !== this) {
                this.imports.set(variable, module_12);
            }
        }
        ...
        for (var _e = 0, _f = Array.from(chunk.exports.entries()); _e < _f.length; _e++) {
            var _g = _f[_e], variable = _g[0], module_13 = _g[1];
            if (!this.exports.has(variable)) {
                this.exports.set(variable, module_13);
            }
        }
            ...
            switch (type) {
                ...
                case 'name':
                    ...
                    for (var _i = 0, _a = _this.orderedModules; _i < _a.length; _i++) {
                        var module_14 = _a[_i];
                        if (module_14.chunkAlias)
                            return module_14.chunkAlias;
                    }
                    return 'chunk';
            }
        }), existingNames);
...
function findFile(file, preserveSymlinks) {
    try {
        ...
        if ((preserveSymlinks && stats.isSymbolicLink()) || stats.isFile()) {
            // check case
            var name_1 = path.basename(file);
            var files = fs.readdirSync(path.dirname(file));
            if (files.indexOf(name_1) !== -1)
                return file;
        }
    }
    catch (err) {
...
var Graph = /** @class */ (function () {
    function Graph(options, watcher) {
        ...
        if (options.cache) {
            if (options.cache.modules)
                for (var _i = 0, _a = options.cache.modules; _i < _a.length; _i++) {
                    var module_1 = _a[_i];
                    this.cachedModules.set(module_1.id, module_1);
                }
        }
        if (options.cache !== false) {
            this.pluginCache = (options.cache && options.cache.plugins) || Object.create(null);
            // increment access counter
            for (var name_1 in this.pluginCache) {
                var cache = this.pluginCache[name_1];
        ...
        if (typeof options.external === 'function') {
            ...
            var external_2 = options.external;
            var ids_1 = new Set(Array.isArray(external_2) ? external_2 : external_2 ? [external_2] : []);
        ...
        for (var _d = 0, _e = ['module', 'exports', '_interopDefault']; _d < _e.length; _d++) {
            var name_2 = _e[_d];
            this.scope.findVariable(name_2); // creates global variable as side-effect
        }
    ...
    Graph.prototype.getCache = function () {
        ...
        for (var name_3 in this.pluginCache) {
            var cache = this.pluginCache[name_3];
            var allDeleted = true;
            ...
            if (allDeleted)
                delete this.pluginCache[name_3];
        }
        return {
    ...
    Graph.prototype.link = function () {
        for (var _i = 0, _a = this.modules; _i < _a.length; _i++) {
            var module_2 = _a[_i];
            module_2.linkDependencies();
        }
        for (var _b = 0, _c = this.modules; _b < _c.length; _b++) {
            var module_3 = _c[_b];
            module_3.bindReferences();
        }
    };
    Graph.prototype.includeMarked = function (modules) {
        if (this.treeshake) {
            ...
            for (var _a = 0, modules_2 = modules; _a < modules_2.length; _a++) {
                var module_5 = modules_2[_a];
                module_5.includeAllInBundle();
            }
        }
    };
        ...
        return this.loadEntryModules(entryModules, manualChunks).then(function (_a) {
            ...
            if (!preserveModules) {
                ...
                for (var _f = 0, orderedModules_1 = orderedModules; _f < orderedModules_1.length; _f++) {
                    var module_6 = orderedModules_1[_f];
                    var entryPointsHashStr = Uint8ArrayToHexString(module_6.entryPointsHash);
                    var curChunk = chunkModules[entryPointsHashStr];
                    if (curChunk) {
                        curChunk.push(module_6);
                    }
                    else {
                        chunkModules[entryPointsHashStr] = [module_6];
                    }
                }
                // create each chunk
                ...
                for (var _g = 0, orderedModules_2 = orderedModules; _g < orderedModules_2.length; _g++) {
                    var module_7 = orderedModules_2[_g];
                    var chunkInstance = new Chunk$1(_this, [module_7]);
                    if (module_7.isEntryPoint || !chunkInstance.isEmpty)
                        chunkInstance.entryModule = module_7;
    ...
    Graph.prototype.fetchModule = function (id, importer) {
        ...
        return Promise.resolve(this.pluginDriver.hookFirst('load', [id]))
            ...
            return _this.fetchAllDependencies(module).then(function () {
                for (var name_4 in module.exports) {
                    if (name_4 !== 'default') {
                        module.exportsAll[name_4] = module.id;
                    }
                }
                module.exportAllSources.forEach(function (source) {
                    ...
                    if (exportAllModule.isExternal)
                        return;
                    for (var name_5 in exportAllModule.exportsAll) {
                        if (name_5 in module.exportsAll) {
                            _this.warn({
                                code: 'NAMESPACE_CONFLICT',
                                reexporter: module.id,
                                name: name_5,
                                sources: [module.exportsAll[name_5], exportAllModule.exportsAll[name_5]],
                                message: "Conflicting namespaces: " + relativeId(module.id) + " re-exports '" + name_5 + "' from both " + relativeId(module.exportsAll[name_5]) + " and " + relativeId(exportAllModule.exportsAll[name_5]) + " (will be ignored)"
                            });
                        }
                        else {
                            module.exportsAll[name_5] = exportAllModule.exportsAll[name_5];
                        }
                    }
                });
                return module;
            ...
            return Promise.resolve()
                ...
                if (isExternal) {
                    ...
                    if (!_this.moduleById.has(externalId)) {
                        var module_8 = new ExternalModule({ graph: _this, id: externalId });
                        _this.externalModules.push(module_8);
                        _this.moduleById.set(externalId, module_8);
                    }
                    ...
                    for (var name_6 in module.imports) {
                        var importDeclaration = module.imports[name_6];
...
function getInputOptions(config, command, defaultOnWarnHandler) {
    ...
    if (Array.isArray(inputOptions.input)) {
        ...
        for (var name_1 in inputOptions.input) {
            inputOptions.entry = inputOptions.input[name_1];
            break;
        }
    }
    else {
            ...
            function generate(rawOutputOptions, isWrite) {
                ...
                return graph_1.pluginDriver
                    ...
                    for (var i = 0; i < chunks.length; i++) {
                        ...
                        var exports_1 = chunk.getExportNames();
